...
<html lang="en-US">
  <head>
    ...
    <link href="Template/CV/css/aos.css" rel="stylesheet">
    <link href="Template/CV/css/bootstrap.min.css" rel="stylesheet">
    <link href="Template/CV/styles/main.css" rel="stylesheet">
  </head>
  <body id="top">
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="HomeForward" rel="tooltip">Về trang web</a>
...
<div class="profile-page">
  <div class="wrapper">
    <div class="page-header page-header-small" filter-color="green">
      <div class="page-header-image" data-parallax="true" style="background-image: url('Template/CV/images/cc-bg-1.jpg');"></div>
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="Template/CV/images/nguyenthanhhien.jpg" alt="Image"/></a></div>
          <div class="h2 title">Nguyễn Thanh Hiền</div>
        ...
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">nguyenthanhhien.itnlu@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">+0343288735</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">Linh Đông,Thủ Đức ,TP.Hồ Chí Minh</div>
            </div>
            <div class="row mt-3">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="Template/CV/images/project-1.jpg" alt="Image"/>
                    <figcaption>
              ...
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="Template/CV/images/project-2.jpg" alt="Image"/>
                    <figcaption>
            ...
            <div class="col-md-6">
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="Template/CV/images/project-3.jpg" alt="Image"/>
                    <figcaption>
              ...
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="Template/CV/images/project-4.jpg" alt="Image"/>
                    <figcaption>
      ...
      <div class="carousel slide" id="cc-Indicators" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="Template/CV/images/reference-image-1.jpg" alt="Image"/>
          ...
          <div class="carousel-item">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="Template/CV/images/reference-image-2.jpg" alt="Image"/>
          ...
          <div class="carousel-item">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="Template/CV/images/reference-image-3.jpg" alt="Image"/>
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('Template/CV/images/staticmap.png');">
    <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2">Linh Đông,Thủ Đức ,TP.Hồ Chí Minh</p>
                    <p class="mb-0"><strong>Phone</strong></p>
                    <p class="pb-2">+0343288735</p>
                    <p class="mb-0"><strong>Email</strong></p>
                    <p>nguyenthanhhien.itnlu@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script src="Template/CV/js/core/jquery.3.2.1.min.js"></script>
    <script src="Template/CV/js/core/popper.min.js"></script>
    <script src="Template/CV/js/core/bootstrap.min.js"></script>
    <script src="Template/CV/js/now-ui-kit.js?v=1.1.0"></script>
    <script src="Template/CV/js/aos.js"></script>
    <script src="Template/CV/scripts/main.js"></script>
  </body>
</html>